...
public:
	...
	void CreateOtherCharacter_SC(short mapID, LONG64 playerID, const WString& nickName, float dirX, float dirY, float locationX, float locationY, bool bDisconnect = false);
	...
	void MoveMyCharacter_SC(short mapID, const Vector<float>& destinationsX, const Vector<float>& destinationsY, bool bDisconnect = false);
	void MoveOtherCharacter_SC(short mapID, LONG64 playerID, const Vector<float>& destinationsX, const Vector<float>& destinationsY, bool bDisconnect = false);
